  ...
  privacy: {
    en: {
      ...
      sections: [
        ...
        { h: 'Sharing & storage', body: ['We use Brevo and Google to store and manage email subscriptions; your data is processed under their security terms. We do not sell your personal information.'] },
      ],
      note: REVIEW_EN,
    },
    zh: {
      ...
      sections: [
        ...
        { h: '共享与存储', body: ['我们使用 Brevo 与 Google 存储与管理邮件订阅，你的数据依其安全条款处理。我们不会出售你的个人信息。'] },
      ],
      note: REVIEW_ZH,
    },
  },
