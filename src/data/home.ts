...
export const home: { en: HomeContent; zh: HomeContent } = {
  en: {
    hero: {
      ...
      t1: "The best supplier doesn't win.",
      t2: 'The one they can <em>find</em> does.',
      ...
      trust1: 'One supplier per category · two clients at a time',
      ...
      card: {
        ...
        msg2: "Yes — that's our main category. Here's our catalog…",
